...
RATIO_LOG_PRODUCER = "ratio_log_producer"
MIN_ACTI_COUNT_IN_PERSPECTIVE = "min_acti_count_in_perspective"

DEFAULT_DEPENDENCY_THRESH = 0.5
DEFAULT_AND_MEASURE_THRESH = 0.65
DEFAULT_MIN_ACT_COUNT = 1
DEFAULT_MIN_DFG_OCCURRENCES = 1
DEFAULT_DFG_PRE_CLEANING_NOISE_THRESH = 0.16
DEFAULT_LOOP_LENGTH_TWO_THRESH = 0.5
DEFAULT_RATIO_LOG_PRODUCER = 0.0
DEFAULT_MIN_ACTI_COUNT_IN_PERSPECTIVE = 2